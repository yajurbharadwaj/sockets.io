...
cnsp.on('connection', function (socket) {   //with this on-method, a predefined object connection is passed into the socket through function 
    console.log('a user connected');

    cnsp.emit('customEvent', { message: 'hello welcome :)' }) //this will show only the new user with a welcome message.
